...
class EntityArrays {
     ...
     */
    static final Map<CharSequence, CharSequence> ISO8859_1_ESCAPE;
    static {
     ...
     */
    static final Map<CharSequence, CharSequence> ISO8859_1_UNESCAPE;
    static {
     ...
     */
    static final Map<CharSequence, CharSequence> HTML40_EXTENDED_ESCAPE;
    static {
        final Map<CharSequence, CharSequence> initialMap = new HashMap<>();
        // <!-- Latin Extended-B -->
     ...
     */
    static final Map<CharSequence, CharSequence> HTML40_EXTENDED_UNESCAPE;
    static {
